...
public class HeapPage {
    ...
    private int getHeaderSize() {
        //your code here
        int Length = td.getSize();
        int SlotsNum = (HeapFile.PAGE_SIZE * 8) / (Length * 8 + 1);
        return (int) Math.ceil(SlotsNum / 8.0);
    }
    ...
    public boolean slotOccupied(int s) {
        ...
        int index = s / 8;
        int position = s % 8;
        return (header[index] >> position & (byte) 1) == 1;
    }
